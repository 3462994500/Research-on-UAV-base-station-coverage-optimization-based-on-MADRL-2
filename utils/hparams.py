...
def override_config(old_config: dict, new_config: dict):#合并字典
...
def set_hparams(config='', exp_name='', hparams_str='', print_hparams=True, global_hparams=True):
    if config == '' and exp_name == '':
        ...
        parser.add_argument('--exp_name', type=str, default='emappo-db-xuexicelue-0128zs', help='exp_name')
        parser.add_argument('--hparams', type=str, default='',
                            help='location of the data corpus')
        parser.add_argument('--display', action='store_true', help='display')
        parser.add_argument('--evaluate', action='store_true', help='evaluate', default=False)
        parser.add_argument('--CFE', action='store_true', help='CFE', default=False)
        parser.add_argument('--user', action='store_true', help='user', default=False)
        parser.add_argument('--user_num', action='store_true', help='user_num', default=False)
        parser.add_argument('--SNR', action='store_true', help='SNR', default=False)
        # parser.add_argument('--outage_probability', action='store_true', help='outage_probability', default=True)
    ...
    hparams_['CFE'] = args.CFE
    hparams_['user'] = args.user
    hparams_['user_num'] = args.user_num
    hparams_['SNR'] = args.SNR
    # hparams_['outage_probability'] = args.outage_probability
