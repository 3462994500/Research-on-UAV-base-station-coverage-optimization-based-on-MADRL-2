...
# hidden_dim = 20
# action_dim = 5
# model = DRGNNetwork(in_dim, hidden_dim, action_dim, num_head=4, skip_connect=False)
#
# # 打印网络结构
# print(model)

# DRGNNetwork(
#   (encoder): Linear(in_features=10, out_features=20, bias=True)
#   (drgn_block): DRGNStackBlock(
#     (att_1): MultiHeadAttentionLayer(
#       (fc_v): Linear(in_features=20, out_features=80, bias=True)
#       (fc_k): Linear(in_features=20, out_features=80, bias=True)
#       (fc_q): Linear(in_features=20, out_features=80, bias=True)
#       (fc_out): Linear(in_features=80, out_features=20, bias=True)
#     )
#     (att_2): MultiHeadAttentionLayer(
#       (fc_v): Linear(in_features=20, out_features=80, bias=True)
#       (fc_k): Linear(in_features=20, out_features=80, bias=True)
#       (fc_q): Linear(in_features=20, out_features=80, bias=True)
#       (fc_out): Linear(in_features=80, out_features=20, bias=True)
#     )
#     (recurrent_layer): GRUCell(20, 20)
